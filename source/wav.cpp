...
namespace utility {
	...
	*/
	...
	bool loadCmpWavData(const std::string fname, complex *wavData, int *size, int *smpFreq, short *bitDepth, short *channels)
	{
		...
		try {
			...
			wavData = new complex[wave_data.subChunk2Size];
